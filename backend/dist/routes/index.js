...
api.route('/transactions/:id').get(c.getTransaction).put(c.updateTransaction).delete(c.removeTransaction);
...
api.route('/groups/:id/contributions').get(c.groupContributions).post(c.addGroupContribution);
